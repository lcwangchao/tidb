...
require (
	...
	github.com/pingcap/kvproto v0.0.0-20251111062912-404ef65745d5
...
replace (
	...
	github.com/tikv/client-go/v2 => github.com/lcwangchao/client-go/v2 v2.0.0-alpha.0.20251113102049-d681aee32713
