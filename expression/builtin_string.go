...
func (c *lengthFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
...
func (c *asciiFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETInt, types.ETString)
...
func (c *concatFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	valStr, _ := ctx.GetSystemVar(variable.MaxAllowedPacket)
...
func (c *concatWSFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinConcatWSSig) evalString(row chunk.Row) (string, bool, error) {
	...
	N := len(args)
	if N > 0 {
		val, isNull, err := args[0].EvalString(row)
		if err != nil || isNull {
	...
	for i := 1; i < N; i++ {
		val, isNull, err := args[i].EvalString(row)
		if err != nil {
			return val, isNull, err
		}
		if isNull {
...
func (c *leftFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinLeftSig) evalString(row chunk.Row) (string, bool, error) {
	str, isNull, err := b.args[0].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}
	left, isNull, err := b.args[1].EvalInt(row)
	if isNull || err != nil {
		return "", true, err
	}
	leftLength := int(left)
...
func (c *rightFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString, types.ETInt)
...
func (b *builtinRightSig) evalString(row chunk.Row) (string, bool, error) {
	...
	right, isNull, err := b.args[1].EvalInt(row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (c *repeatFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString, types.ETInt)
...
func (b *builtinRepeatSig) evalString(row chunk.Row) (d string, isNull bool, err error) {
	...
	num, isNull, err := b.args[1].EvalInt(row)
	if isNull || err != nil {
		return "", isNull, err
	}
	if num < 1 {
...
func (c *lowerFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinLowerUTF8Sig) evalString(row chunk.Row) (d string, isNull bool, err error) {
	d, isNull, err = b.args[0].EvalString(row)
	if isNull || err != nil {
		return d, isNull, err
	}
...
func (c *reverseFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (c *spaceFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinSpaceSig) evalString(row chunk.Row) (d string, isNull bool, err error) {
	...
	x, isNull, err = b.args[0].EvalInt(row)
	if isNull || err != nil {
		return d, isNull, err
	}
	if x < 0 {
...
func (c *upperFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (c *strcmpFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinStrcmpSig) evalInt(row chunk.Row) (int64, bool, error) {
	...
	left, isNull, err = b.args[0].EvalString(row)
	if isNull || err != nil {
		return 0, isNull, err
	}
	right, isNull, err = b.args[1].EvalString(row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *replaceFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinReplaceSig) evalString(row chunk.Row) (d string, isNull bool, err error) {
	...
	oldStr, isNull, err = b.args[1].EvalString(row)
	if isNull || err != nil {
		return d, isNull, err
	}
	newStr, isNull, err = b.args[2].EvalString(row)
	if isNull || err != nil {
		return d, isNull, err
	}
	if oldStr == "" {
...
func (c *convertFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (c *substringFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinSubstring2ArgsSig) evalString(row chunk.Row) (string, bool, error) {
	...
	pos, isNull, err := b.args[1].EvalInt(row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (b *builtinSubstring3ArgsSig) evalString(row chunk.Row) (string, bool, error) {
	...
	length, isNull, err := b.args[2].EvalInt(row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (c *substringIndexFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinSubstringIndexSig) evalString(row chunk.Row) (d string, isNull bool, err error) {
	...
	delim, isNull, err = b.args[1].EvalString(row)
	if isNull || err != nil {
		return d, isNull, err
	}
	count, isNull, err = b.args[2].EvalInt(row)
	if isNull || err != nil {
		return d, isNull, err
	}
	if len(delim) == 0 {
...
func (c *locateFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinLocate2ArgsSig) evalInt(row chunk.Row) (int64, bool, error) {
	subStr, isNull, err := b.args[0].EvalString(row)
	if isNull || err != nil {
		return 0, isNull, err
	}
	str, isNull, err := b.args[1].EvalString(row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinLocate3ArgsSig) evalInt(row chunk.Row) (int64, bool, error) {
	...
	pos, isNull, err := b.args[2].EvalInt(row)
...
func (c *hexFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (c *unhexFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	var retFlen int
...
func (c *trimFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinTrim2ArgsSig) evalString(row chunk.Row) (d string, isNull bool, err error) {
	...
	remstr, isNull, err = b.args[1].EvalString(row)
	if isNull || err != nil {
		return d, isNull, err
	}
...
func (b *builtinTrim3ArgsSig) evalString(row chunk.Row) (d string, isNull bool, err error) {
	...
	remstr, isRemStrNull, err = b.args[1].EvalString(row)
	if err != nil || isRemStrNull {
		return d, isRemStrNull, err
	}
	x, isNull, err = b.args[2].EvalInt(row)
	if isNull || err != nil {
		return d, isNull, err
	}
...
func (c *lTrimFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (c *rTrimFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func getFlen4LpadAndRpad(arg Expression) int {
	if constant, ok := arg.(*Constant); ok {
		length, isNull, err := constant.EvalInt(chunk.Row{})
		if err != nil {
...
func (c *lpadFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	bf.tp.SetFlen(getFlen4LpadAndRpad(args[1]))
	addBinFlag(bf.tp)
...
func (b *builtinLpadSig) evalString(row chunk.Row) (string, bool, error) {
	...
	length, isNull, err := b.args[1].EvalInt(row)
	if isNull || err != nil {
		return "", true, err
	}
	...
	padStr, isNull, err := b.args[2].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (c *rpadFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString, types.ETInt, types.ETString)
...
func (c *bitLengthFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETInt, types.ETString)
...
func (c *charFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
	...
	charsetName, isNull, err := args[len(args)-1].EvalString(chunk.Row{})
	if err != nil {
		return nil, err
	}
	if isNull {
...
func (b *builtinCharSig) evalString(row chunk.Row) (string, bool, error) {
	...
	for i := 0; i < len(b.args)-1; i++ {
		val, IsNull, err := b.args[i].EvalInt(row)
		if err != nil {
			return "", true, err
		}
		if IsNull {
...
func (c *charLengthFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
...
func (c *findInSetFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETInt, types.ETString, types.ETString)
...
func (b *builtinFindInSetSig) evalInt(row chunk.Row) (int64, bool, error) {
	...
	strlist, isNull, err := b.args[1].EvalString(row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *fieldFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinFieldIntSig) evalInt(row chunk.Row) (int64, bool, error) {
	str, isNull, err := b.args[0].EvalInt(row)
	if isNull || err != nil {
		return 0, err != nil, err
	}
	for i, length := 1, len(b.args); i < length; i++ {
		stri, isNull, err := b.args[i].EvalInt(row)
		if err != nil {
			return 0, true, err
		}
		if !isNull && str == stri {
...
func (b *builtinFieldRealSig) evalInt(row chunk.Row) (int64, bool, error) {
	str, isNull, err := b.args[0].EvalReal(row)
	if isNull || err != nil {
		return 0, err != nil, err
	}
	for i, length := 1, len(b.args); i < length; i++ {
		stri, isNull, err := b.args[i].EvalReal(row)
		if err != nil {
			return 0, true, err
		}
		if !isNull && str == stri {
...
func (b *builtinFieldStringSig) evalInt(row chunk.Row) (int64, bool, error) {
	...
	for i, length := 1, len(b.args); i < length; i++ {
		stri, isNull, err := b.args[i].EvalString(row)
		if err != nil {
			return 0, true, err
		}
...
func (c *makeSetFunctionClass) getFlen(args []Expression) int {
	flen, count := 0, 0
	if constant, ok := args[0].(*Constant); ok {
		bits, isNull, err := constant.EvalInt(chunk.Row{})
		if err == nil && !isNull {
...
func (c *makeSetFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, len(args))
...
func (b *builtinMakeSetSig) evalString(row chunk.Row) (string, bool, error) {
	bits, isNull, err := b.args[0].EvalInt(row)
	if isNull || err != nil {
		return "", true, err
	}
	...
	for i, length := 1, len(b.args); i < length; i++ {
		...
		str, isNull, err := b.args[i].EvalString(row)
		if err != nil {
			return "", true, err
		}
		if !isNull {
...
func (c *octFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	var sig builtinFunc
...
func (b *builtinOctIntSig) evalString(row chunk.Row) (string, bool, error) {
	val, isNull, err := b.args[0].EvalInt(row)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (c *ordFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETInt, types.ETString)
...
func (c *quoteFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (c *binFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETInt)
...
func (c *eltFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if argsErr := c.verifyArgs(args); argsErr != nil {
		return nil, argsErr
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinEltSig) evalString(row chunk.Row) (string, bool, error) {
	idx, isNull, err := b.args[0].EvalInt(row)
	if isNull || err != nil {
		return "", true, err
	}
	...
	arg, isNull, err := b.args[idx].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (c *exportSetFunctionClass) getFunction(ctx *ExprContext, args []Expression) (sig builtinFunc, err error) {
	if err = c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinExportSet3ArgSig) evalString(row chunk.Row) (string, bool, error) {
	...
	on, isNull, err := b.args[1].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}

	off, isNull, err := b.args[2].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (b *builtinExportSet4ArgSig) evalString(row chunk.Row) (string, bool, error) {
	...
	separator, isNull, err := b.args[3].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (b *builtinExportSet5ArgSig) evalString(row chunk.Row) (string, bool, error) {
	...
	numberOfBits, isNull, err := b.args[4].EvalInt(row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (c *formatFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func evalNumDecArgsForFormat(f builtinFunc, row chunk.Row) (string, string, bool, error) {
	...
	if arg0.GetType().EvalType() == types.ETDecimal {
		x, isNull, err := arg0.EvalDecimal(row)
		if isNull || err != nil {
			return "", "", isNull, err
		}
		xStr = x.String()
	} else {
		x, isNull, err := arg0.EvalReal(row)
		if isNull || err != nil {
			return "", "", isNull, err
		}
		xStr = strconv.FormatFloat(x, 'f', -1, 64)
	}
	d, isNull, err := arg1.EvalInt(row)
	if isNull || err != nil {
		return "", "", isNull, err
	}
	if d < 0 {
...
func (b *builtinFormatWithLocaleSig) evalString(row chunk.Row) (string, bool, error) {
	...
	locale, isNull, err := b.args[2].EvalString(row)
	if err != nil {
		return "", false, err
	}
	if isNull {
		b.ctx.StmtCtx.AppendWarning(errUnknownLocale.GenWithStackByArgs("NULL"))
	} else if !strings.EqualFold(locale, "en_US") { // TODO: support other locales.
		b.ctx.StmtCtx.AppendWarning(errUnknownLocale.GenWithStackByArgs(locale))
	}
	locale = "en_US"
...
func (c *fromBase64FunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (c *toBase64FunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (c *insertFunctionClass) getFunction(ctx *ExprContext, args []Expression) (sig builtinFunc, err error) {
	if err = c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinInsertSig) evalString(row chunk.Row) (string, bool, error) {
	...
	newstr, isNull, err := b.args[3].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (c *instrFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETInt, types.ETString, types.ETString)
...
func (b *builtinInstrUTF8Sig) evalInt(row chunk.Row) (int64, bool, error) {
	...
	substr, IsNull, err := b.args[1].EvalString(row)
	if IsNull || err != nil {
		return 0, true, err
	}
	if collate.IsCICollation(b.collation) {
...
func (c *loadFileFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (c *weightStringFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
...
func (b *builtinWeightStringSig) evalString(row chunk.Row) (string, bool, error) {
	...
	case weightStringPaddingAsBinary:
		...
		if b.length < lenStr {
			...
			b.ctx.StmtCtx.AppendWarning(errTruncatedWrongValue.GenWithStackByArgs(tpInfo, str))
			str = str[:b.length]
...
func (c *translateFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString, types.ETString, types.ETString)
...
func (b *builtinTranslateBinarySig) evalString(row chunk.Row) (d string, isNull bool, err error) {
	...
	srcStr, isNull, err = b.args[0].EvalString(row)
	if isNull || err != nil {
		return d, isNull, err
	}
	fromStr, isFromStrNull, err = b.args[1].EvalString(row)
	if isFromStrNull || err != nil {
		return d, isFromStrNull, err
	}
	toStr, isToStrNull, err = b.args[2].EvalString(row)
