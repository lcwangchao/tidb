...
func (c *aesDecryptFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	...
	blockMode, _ := ctx.GetSystemVar(variable.BlockEncryptionMode)
...
func (b *builtinAesDecryptSig) evalString(row chunk.Row) (string, bool, error) {
	...
	cryptStr, isNull, err := b.args[0].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}
	keyStr, isNull, err := b.args[1].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}
	if !b.ivRequired && len(b.args) == 3 {
		...
		b.ctx.StmtCtx.AppendWarning(errWarnOptionIgnored.GenWithStackByArgs("IV"))
	}
...
func (b *builtinAesDecryptIVSig) evalString(row chunk.Row) (string, bool, error) {
	...
	iv, isNull, err := b.args[2].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (c *aesEncryptFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, c.verifyArgs(args)
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (c *decodeFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinDecodeSig) evalString(row chunk.Row) (string, bool, error) {
	dataStr, isNull, err := b.args[0].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}

	passwordStr, isNull, err := b.args[1].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (c *desDecryptFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
...
func (c *desEncryptFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
...
func (c *encodeFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinEncodeSig) evalString(row chunk.Row) (string, bool, error) {
	decodeStr, isNull, err := b.args[0].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (c *encryptFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
...
func (c *oldPasswordFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
...
func (c *passwordFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinPasswordSig) evalString(row chunk.Row) (d string, isNull bool, err error) {
	pass, isNull, err := b.args[0].EvalString(row)
	if isNull || err != nil {
		return "", isNull, err
	}
	...
	// See https://dev.mysql.com/doc/refman/5.7/en/encryption-functions.html#function_password
	b.ctx.StmtCtx.AppendWarning(errDeprecatedSyntaxNoReplacement.GenWithStackByArgs("PASSWORD"))
...
func (c *randomBytesFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (c *md5FunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (b *builtinMD5Sig) evalString(row chunk.Row) (string, bool, error) {
	arg, isNull, err := b.args[0].EvalString(row)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (c *sha1FunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (c *sha2FunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (c *sm3FunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (b *builtinSHA2Sig) evalString(row chunk.Row) (string, bool, error) {
	...
	hashLength, isNull, err := b.args[1].EvalInt(row)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (c *compressFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (c *uncompressFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (b *builtinUncompressSig) evalString(row chunk.Row) (string, bool, error) {
	sc := b.ctx.StmtCtx
	payload, isNull, err := b.args[0].EvalString(row)
	if isNull || err != nil {
		return "", true, err
	}
	if len(payload) == 0 {
...
func (c *uncompressedLengthFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (c *validatePasswordStrengthFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETInt, types.ETString)
...
func (b *builtinValidatePasswordStrengthSig) evalInt(row chunk.Row) (int64, bool, error) {
	globalVars := b.ctx.GlobalVarsAccessor
	str, isNull, err := b.args[0].EvalString(row)
	if err != nil || isNull {
		return 0, true, err
...
func (b *builtinValidatePasswordStrengthSig) validateStr(str string, globalVars *variable.GlobalVarAccessor) (int64, bool, error) {
	if warn, err := pwdValidator.ValidateUserNameInPassword(str, b.ctx.CurrentUser, b.ctx.GlobalVarsAccessor); err != nil {
		return 0, true, err
	} else if len(warn) > 0 {
		return 0, false, nil
	}
