...
func (c *logicAndFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
...
func (c *logicOrFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	err := c.verifyArgs(args)
	if err != nil {
		return nil, err
	}
...
func (c *logicXorFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	err := c.verifyArgs(args)
	if err != nil {
		return nil, err
	}
...
func (b *builtinLogicXorSig) evalInt(row chunk.Row) (int64, bool, error) {
	...
	arg1, isNull, err := b.args[1].EvalInt(row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (c *bitAndFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	err := c.verifyArgs(args)
	if err != nil {
		return nil, err
	}
...
func (c *bitOrFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	err := c.verifyArgs(args)
	if err != nil {
		return nil, err
	}
...
func (c *bitXorFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	err := c.verifyArgs(args)
	if err != nil {
		return nil, err
	}
...
func (c *leftShiftFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	err := c.verifyArgs(args)
	if err != nil {
		return nil, err
	}
...
func (c *rightShiftFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	err := c.verifyArgs(args)
	if err != nil {
		return nil, err
	}
...
func (c *isTrueOrFalseFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
...
func (b *builtinRealIsTrueSig) evalInt(row chunk.Row) (int64, bool, error) {
	input, isNull, err := b.args[0].EvalReal(row)
	if err != nil {
		return 0, true, err
	}
...
func (b *builtinDecimalIsTrueSig) evalInt(row chunk.Row) (int64, bool, error) {
	input, isNull, err := b.args[0].EvalDecimal(row)
	if err != nil {
		return 0, true, err
	}
	if b.keepNull && isNull {
...
func (b *builtinIntIsTrueSig) evalInt(row chunk.Row) (int64, bool, error) {
	input, isNull, err := b.args[0].EvalInt(row)
	if err != nil {
		return 0, true, err
	}
	if b.keepNull && isNull {
...
func (c *bitNegFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (c *unaryNotFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	...
	case types.ETJson:
		ctx.StmtCtx.AppendWarning(errJSONInBooleanContext)
...
func (b *builtinUnaryNotRealSig) evalInt(row chunk.Row) (int64, bool, error) {
	arg, isNull, err := b.args[0].EvalReal(row)
	if isNull || err != nil {
		return 0, true, err
	}
	if arg == 0 {
...
func (b *builtinUnaryNotDecimalSig) evalInt(row chunk.Row) (int64, bool, error) {
	arg, isNull, err := b.args[0].EvalDecimal(row)
	if isNull || err != nil {
		return 0, true, err
	}
	if arg.IsZero() {
...
func (b *builtinUnaryNotJSONSig) evalInt(row chunk.Row) (int64, bool, error) {
	arg, isNull, err := b.args[0].EvalJSON(row)
	if isNull || err != nil {
		return 0, true, err
	}
...
func (c *unaryMinusFunctionClass) getFunction(ctx *ExprContext, args []Expression) (sig builtinFunc, err error) {
	if err = c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinUnaryMinusDecimalSig) evalDecimal(row chunk.Row) (*types.MyDecimal, bool, error) {
	dec, isNull, err := b.args[0].EvalDecimal(row)
	if err != nil || isNull {
...
func (c *isNullFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTp := args[0].GetType().EvalType()
...
func (b *builtinDecimalIsNullSig) evalInt(row chunk.Row) (int64, bool, error) {
	_, isNull, err := b.args[0].EvalDecimal(row)
...
func (b *builtinDurationIsNullSig) evalInt(row chunk.Row) (int64, bool, error) {
	_, isNull, err := b.args[0].EvalDuration(row)
	return evalIsNull(isNull, err)
}
...
func (b *builtinIntIsNullSig) evalInt(row chunk.Row) (int64, bool, error) {
	_, isNull, err := b.args[0].EvalInt(row)
	return evalIsNull(isNull, err)
}
...
func (b *builtinRealIsNullSig) evalInt(row chunk.Row) (int64, bool, error) {
	_, isNull, err := b.args[0].EvalReal(row)
	return evalIsNull(isNull, err)
}
...
func (b *builtinStringIsNullSig) evalInt(row chunk.Row) (int64, bool, error) {
	_, isNull, err := b.args[0].EvalString(row)
	return evalIsNull(isNull, err)
}
...
func (b *builtinTimeIsNullSig) evalInt(row chunk.Row) (int64, bool, error) {
	_, isNull, err := b.args[0].EvalTime(row)
	return evalIsNull(isNull, err)
}
