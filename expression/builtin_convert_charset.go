...
func (c *tidbToBinaryFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
...
func (c *tidbFromBinaryFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, c.verifyArgs(args)
	}
	argTp := args[0].GetType().EvalType()
...
func BuildToBinaryFunction(ctx *ExprContext, expr Expression) (res Expression) {
...
func BuildFromBinaryFunction(ctx *ExprContext, expr Expression, tp *types.FieldType) (res Expression) {
...
func HandleBinaryLiteral(ctx *ExprContext, expr Expression, ec *ExprCollation, funcName string) Expression {
