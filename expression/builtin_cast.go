...
func convertJSON2Tp(evalType types.EvalType) func(*stmtctx.StatementContext, types.BinaryJSON, *types.FieldType) (any, error) {
	...
	case types.ETString:
		return func(sc *stmtctx.StatementContext, item types.BinaryJSON, tp *types.FieldType) (any, error) {
			...
			return types.ProduceStrWithSpecifiedTp(string(item.GetString()), tp, sc.ValCtx, false)
		}
	case types.ETInt:
		return func(sc *stmtctx.StatementContext, item types.BinaryJSON, tp *types.FieldType) (any, error) {
			...
			jsonToInt, err := types.ConvertJSONToInt(sc.ValCtx, item, mysql.HasUnsignedFlag(tp.GetFlag()), tp.GetType())
	...
	case types.ETReal:
		return func(sc *stmtctx.StatementContext, item types.BinaryJSON, tp *types.FieldType) (any, error) {
			...
			return types.ConvertJSONToFloat(sc.ValCtx, item)
		}
...
func (b *builtinCastIntAsDecimalSig) evalDecimal(row chunk.Row) (res *types.MyDecimal, isNull bool, err error) {
	...
	res, err = types.ProduceDecWithSpecifiedTp(res, b.tp, b.ctx.GetSessionVars().StmtCtx.ValCtx)
	return res, isNull, err
}
...
func (b *builtinCastIntAsStringSig) evalString(row chunk.Row) (res string, isNull bool, err error) {
	...
	res, err = types.ProduceStrWithSpecifiedTp(res, b.tp, b.ctx.GetSessionVars().StmtCtx.ValCtx, false)
	if err != nil {
		return res, false, err
	}
...
func (b *builtinCastIntAsTimeSig) evalTime(row chunk.Row) (res types.Time, isNull bool, err error) {
	...
	if b.args[0].GetType().GetType() == mysql.TypeYear {
		res, err = types.ParseTimeFromYear(b.ctx.GetSessionVars().StmtCtx.ValCtx, val)
	} else {
		res, err = types.ParseTimeFromNum(b.ctx.GetSessionVars().StmtCtx.ValCtx, val, b.tp.GetType(), b.tp.GetDecimal())
	}
...
func (b *builtinCastIntAsDurationSig) evalDuration(row chunk.Row) (res types.Duration, isNull bool, err error) {
	...
	dur, err := types.NumberToDuration(b.ctx.GetSessionVars().StmtCtx.ValCtx, val, b.tp.GetDecimal())
	if err != nil {
...
func (b *builtinCastRealAsIntSig) evalInt(row chunk.Row) (res int64, isNull bool, err error) {
	...
	if !mysql.HasUnsignedFlag(b.tp.GetFlag()) {
		res, err = types.ConvertFloatToInt(b.ctx.GetSessionVars().StmtCtx.ValCtx, val, types.IntergerSignedLowerBound(mysql.TypeLonglong), types.IntergerSignedUpperBound(mysql.TypeLonglong), mysql.TypeLonglong)
	} else if b.inUnion && val < 0 {
		res = 0
	} else {
		var uintVal uint64
		sc := b.ctx.GetSessionVars().StmtCtx
		uintVal, err = types.ConvertFloatToUint(sc.ValCtx, val, types.IntergerUnsignedUpperBound(mysql.TypeLonglong), mysql.TypeLonglong)
		res = int64(uintVal)
	}
	if types.ErrOverflow.Equal(err) {
		err = b.ctx.GetSessionVars().StmtCtx.HandleOverflow(err, err)
...
func (b *builtinCastRealAsStringSig) evalString(row chunk.Row) (res string, isNull bool, err error) {
	...
	res, err = types.ProduceStrWithSpecifiedTp(strconv.FormatFloat(val, 'f', -1, bits), b.tp, b.ctx.GetSessionVars().StmtCtx.ValCtx, false)
	if err != nil {
		return res, false, err
	}
	return padZeroForBinaryType(res, b.tp, b.ctx)
...
func (b *builtinCastRealAsTimeSig) evalTime(row chunk.Row) (types.Time, bool, error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	res, err := types.ParseTimeFromFloatString(sc.ValCtx, fv, b.tp.GetType(), b.tp.GetDecimal())
	if err != nil {
		return types.ZeroTime, true, handleInvalidTimeError(b.ctx, err)
	}
	if b.tp.GetType() == mysql.TypeDate {
...
func (b *builtinCastRealAsDurationSig) evalDuration(row chunk.Row) (res types.Duration, isNull bool, err error) {
	...
	res, _, err = types.ParseDuration(b.ctx.GetSessionVars().StmtCtx.ValCtx, strconv.FormatFloat(val, 'f', -1, 64), b.tp.GetDecimal())
	if err != nil {
		if types.ErrTruncatedWrongVal.Equal(err) {
			err = b.ctx.GetSessionVars().StmtCtx.HandleTruncate(err)
...
func (b *builtinCastDecimalAsDecimalSig) evalDecimal(row chunk.Row) (res *types.MyDecimal, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	res, err = types.ProduceDecWithSpecifiedTp(res, b.tp, sc.ValCtx)
	return res, false, err
}
...
func (b *builtinCastDecimalAsStringSig) evalString(row chunk.Row) (res string, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	res, err = types.ProduceStrWithSpecifiedTp(string(val.ToString()), b.tp, sc.ValCtx, false)
	if err != nil {
		return res, false, err
	}
	return padZeroForBinaryType(res, b.tp, b.ctx)
...
func (b *builtinCastDecimalAsTimeSig) evalTime(row chunk.Row) (res types.Time, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	res, err = types.ParseTimeFromFloatString(sc.ValCtx, string(val.ToString()), b.tp.GetType(), b.tp.GetDecimal())
	if err != nil {
		return types.ZeroTime, true, handleInvalidTimeError(b.ctx, err)
	}
	if b.tp.GetType() == mysql.TypeDate {
...
func (b *builtinCastDecimalAsDurationSig) evalDuration(row chunk.Row) (res types.Duration, isNull bool, err error) {
	...
	res, _, err = types.ParseDuration(b.ctx.GetSessionVars().StmtCtx.ValCtx, string(val.ToString()), b.tp.GetDecimal())
	if types.ErrTruncatedWrongVal.Equal(err) {
		err = b.ctx.GetSessionVars().StmtCtx.HandleTruncate(err)
		// ErrTruncatedWrongVal needs to be considered NULL.
		return res, true, err
...
func (b *builtinCastStringAsStringSig) evalString(row chunk.Row) (res string, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	res, err = types.ProduceStrWithSpecifiedTp(res, b.tp, sc.ValCtx, false)
	if err != nil {
		return res, false, err
	}
	return padZeroForBinaryType(res, b.tp, b.ctx)
...
func (b *builtinCastStringAsRealSig) evalReal(row chunk.Row) (res float64, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	res, err = types.StrToFloat(sc.ValCtx, val, true)
	if err != nil {
		return 0, false, err
	}
	if b.inUnion && mysql.HasUnsignedFlag(b.tp.GetFlag()) && res < 0 {
...
func (b *builtinCastStringAsTimeSig) evalTime(row chunk.Row) (res types.Time, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	res, err = types.ParseTime(sc.ValCtx, val, b.tp.GetType(), b.tp.GetDecimal(), nil)
	if err != nil {
		return types.ZeroTime, true, handleInvalidTimeError(b.ctx, err)
	}
...
func (b *builtinCastStringAsDurationSig) evalDuration(row chunk.Row) (res types.Duration, isNull bool, err error) {
	...
	res, isNull, err = types.ParseDuration(b.ctx.GetSessionVars().StmtCtx.ValCtx, val, b.tp.GetDecimal())
	if types.ErrTruncatedWrongVal.Equal(err) {
		sc := b.ctx.GetSessionVars().StmtCtx
...
func (b *builtinCastTimeAsTimeSig) evalTime(row chunk.Row) (res types.Time, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	if res, err = res.Convert(sc.ValCtx, b.tp.GetType()); err != nil {
		return types.ZeroTime, true, handleInvalidTimeError(b.ctx, err)
	}
	res, err = res.RoundFrac(sc.ValCtx, b.tp.GetDecimal())
	if b.tp.GetType() == mysql.TypeDate {
		// Truncate hh:mm:ss part if the type is Date.
		res.SetCoreTime(types.FromDate(res.Year(), res.Month(), res.Day(), 0, 0, 0, 0))
...
func (b *builtinCastTimeAsIntSig) evalInt(row chunk.Row) (res int64, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	t, err := val.RoundFrac(sc.ValCtx, types.DefaultFsp)
	if err != nil {
		return res, false, err
	}
...
func (b *builtinCastTimeAsDecimalSig) evalDecimal(row chunk.Row) (res *types.MyDecimal, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	res, err = types.ProduceDecWithSpecifiedTp(val.ToNumber(), b.tp, sc.ValCtx)
	return res, false, err
}
...
func (b *builtinCastTimeAsStringSig) evalString(row chunk.Row) (res string, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	res, err = types.ProduceStrWithSpecifiedTp(val.String(), b.tp, sc.ValCtx, false)
	if err != nil {
		return res, false, err
	}
	return padZeroForBinaryType(res, b.tp, b.ctx)
...
func (b *builtinCastDurationAsTimeSig) evalTime(row chunk.Row) (res types.Time, isNull bool, err error) {
	...
	res, err = val.ConvertToTimeWithTimestamp(sc.ValCtx, b.tp.GetType(), ts)
	if err != nil {
		return types.ZeroTime, true, handleInvalidTimeError(b.ctx, err)
	}
	res, err = res.RoundFrac(sc.ValCtx, b.tp.GetDecimal())
...
func (b *builtinCastJSONAsIntSig) evalInt(row chunk.Row) (res int64, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	res, err = types.ConvertJSONToInt64(sc.ValCtx, val, mysql.HasUnsignedFlag(b.tp.GetFlag()))
	return
}
...
func (b *builtinCastJSONAsRealSig) evalReal(row chunk.Row) (res float64, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	res, err = types.ConvertJSONToFloat(sc.ValCtx, val)
	return
}
...
func (b *builtinCastJSONAsDecimalSig) evalDecimal(row chunk.Row) (res *types.MyDecimal, isNull bool, err error) {
	...
	sc := b.ctx.GetSessionVars().StmtCtx
	res, err = types.ConvertJSONToDecimal(sc.ValCtx, val)
	if err != nil {
		return res, false, err
	}
	res, err = types.ProduceDecWithSpecifiedTp(res, b.tp, sc.ValCtx)
...
func (b *builtinCastJSONAsStringSig) evalString(row chunk.Row) (res string, isNull bool, err error) {
	...
	s, err := types.ProduceStrWithSpecifiedTp(val.String(), b.tp, b.ctx.GetSessionVars().StmtCtx.ValCtx, false)
	if err != nil {
		return res, false, err
	}
	return s, false, nil
...
func (b *builtinCastJSONAsTimeSig) evalTime(row chunk.Row) (res types.Time, isNull bool, err error) {
	...
	case types.JSONTypeCodeDuration:
		...
		res, err = duration.ConvertToTimeWithTimestamp(sc.ValCtx, b.tp.GetType(), ts)
		if err != nil {
			return types.ZeroTime, true, handleInvalidTimeError(b.ctx, err)
		}
		res, err = res.RoundFrac(sc.ValCtx, b.tp.GetDecimal())
	...
	case types.JSONTypeCodeString:
		...
		sc := b.ctx.GetSessionVars().StmtCtx
		res, err = types.ParseTime(sc.ValCtx, s, b.tp.GetType(), b.tp.GetDecimal(), nil)
		if err != nil {
			return types.ZeroTime, true, handleInvalidTimeError(b.ctx, err)
		}
		if b.tp.GetType() == mysql.TypeDate {
...
func (b *builtinCastJSONAsDurationSig) evalDuration(row chunk.Row) (res types.Duration, isNull bool, err error) {
	...
	case types.JSONTypeCodeString:
		...
		res, _, err = types.ParseDuration(stmtCtx.ValCtx, s, b.tp.GetDecimal())
		if types.ErrTruncatedWrongVal.Equal(err) {
			sc := b.ctx.GetSessionVars().StmtCtx
			err = sc.HandleTruncate(err)
		}
