...
func (c *jsonTypeFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
...
func (b *builtinJSONTypeSig) evalString(row chunk.Row) (res string, isNull bool, err error) {
	...
	j, isNull, err = b.args[0].EvalJSON(row)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (c *jsonExtractFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinJSONExtractSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(row)
	if isNull || err != nil {
		return
	}
	...
	for _, arg := range b.args[1:] {
		var s string
		s, isNull, err = arg.EvalString(row)
		if isNull || err != nil {
...
func (c *jsonUnquoteFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (c *jsonSetFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	if len(args)&1 != 1 {
...
func (b *builtinJSONSetSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = jsonModify(b.args, row, types.JSONModifySet)
	return res, isNull, err
}
...
func (c *jsonInsertFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	if len(args)&1 != 1 {
...
func (b *builtinJSONInsertSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = jsonModify(b.args, row, types.JSONModifyInsert)
	return res, isNull, err
}
...
func (c *jsonReplaceFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	if len(args)&1 != 1 {
...
func (b *builtinJSONReplaceSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = jsonModify(b.args, row, types.JSONModifyReplace)
	return res, isNull, err
}
...
func (c *jsonRemoveFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinJSONRemoveSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *jsonMergeFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinJSONMergeSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	values := make([]types.BinaryJSON, 0, len(b.args))
	for _, arg := range b.args {
		var value types.BinaryJSON
		value, isNull, err = arg.EvalJSON(row)
		if isNull || err != nil {
			return res, isNull, err
		}
	...
	if b.pbCode == tipb.ScalarFuncSig_JsonMergeSig {
		b.ctx.StmtCtx.AppendWarning(errDeprecatedSyntaxNoReplacement.GenWithStackByArgs("JSON_MERGE"))
	}
	return res, false, nil
}
...
func (c *jsonObjectFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	if len(args)&1 != 0 {
...
func (b *builtinJSONObjectSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	if len(b.args)&1 == 1 {
	...
	for i, arg := range b.args {
		if i&1 == 0 {
			key, isNull, err = arg.EvalString(row)
			if err != nil {
				return res, true, err
			}
			if isNull {
...
func (c *jsonArrayFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinJSONArraySig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	jsons := make([]interface{}, 0, len(b.args))
	for _, arg := range b.args {
		j, isNull, err := arg.EvalJSON(row)
		if err != nil {
			return res, true, err
		}
		if isNull {
...
func (c *jsonContainsPathFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinJSONContainsPathSig) evalInt(row chunk.Row) (res int64, isNull bool, err error) {
	obj, isNull, err := b.args[0].EvalJSON(row)
	if isNull || err != nil {
		return res, isNull, err
	}
	containType, isNull, err := b.args[1].EvalString(row)
	if isNull || err != nil {
		return res, isNull, err
	}
	...
	for i := 2; i < len(b.args); i++ {
		path, isNull, err := b.args[i].EvalString(row)
		if isNull || err != nil {
			return res, isNull, err
		}
...
func jsonModify(args []Expression, row chunk.Row, mt types.JSONModifyType) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = args[0].EvalJSON(row)
	if isNull || err != nil {
		return res, isNull, err
	}
	...
	for i := 1; i < len(args); i += 2 {
		...
		var s string
		s, isNull, err = args[i].EvalString(row)
		if isNull || err != nil {
			return res, isNull, err
		}
		var pathExpr types.JSONPathExpression
	...
	for i := 2; i < len(args); i += 2 {
		var value types.BinaryJSON
		value, isNull, err = args[i].EvalJSON(row)
		if err != nil {
			return res, true, err
		}
		if isNull {
...
func (c *jsonMemberOfFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinJSONMemberOfSig) evalInt(row chunk.Row) (res int64, isNull bool, err error) {
	target, isNull, err := b.args[0].EvalJSON(row)
	if isNull || err != nil {
		return res, isNull, err
	}
	obj, isNull, err := b.args[1].EvalJSON(row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *jsonContainsFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinJSONContainsSig) evalInt(row chunk.Row) (res int64, isNull bool, err error) {
	...
	target, isNull, err := b.args[1].EvalJSON(row)
	if isNull || err != nil {
		return res, isNull, err
	}
	var pathExpr types.JSONPathExpression
	if len(b.args) == 3 {
		path, isNull, err := b.args[2].EvalString(row)
		if isNull || err != nil {
			return res, isNull, err
		}
...
func (c *jsonOverlapsFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (c *jsonValidFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinJSONValidJSONSig) evalInt(row chunk.Row) (res int64, isNull bool, err error) {
	_, isNull, err = b.args[0].EvalJSON(row)
	return 1, isNull, err
}
...
func (c *jsonArrayAppendFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinJSONArrayAppendSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(row)
	if err != nil || isNull {
		return res, true, err
	}
	...
	for i := 1; i < len(b.args)-1; i += 2 {
		...
		s, sNull, err := b.args[i].EvalString(row)
		if sNull || err != nil {
			return res, true, err
		}
		value, vNull, err := b.args[i+1].EvalJSON(row)
		if err != nil {
			return res, true, err
		}
		if vNull {
...
func (c *jsonArrayInsertFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	if len(args)&1 != 1 {
...
func (b *builtinJSONArrayInsertSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(row)
	if err != nil || isNull {
		return res, true, err
	}
	...
	for i := 1; i < len(b.args)-1; i += 2 {
		// If JSON path is NULL, MySQL breaks and returns NULL.
		s, isNull, err := b.args[i].EvalString(row)
		if err != nil || isNull {
			return res, true, err
		}
		...
		value, isnull, err := b.args[i+1].EvalJSON(row)
		if err != nil {
			return res, true, err
		}
...
func (c *jsonMergePatchFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (b *builtinJSONMergePatchSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	values := make([]*types.BinaryJSON, 0, len(b.args))
	for _, arg := range b.args {
		var value types.BinaryJSON
		value, isNull, err = arg.EvalJSON(row)
...
func (c *jsonMergePreserveFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	argTps := make([]types.EvalType, 0, len(args))
...
func (c *jsonPrettyFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (c *jsonQuoteFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
	bf, err := newBaseBuiltinFuncWithTp(ctx, c.funcName, args, types.ETString, types.ETString)
...
func (c *jsonSearchFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinJSONSearchSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	// json_doc
	...
	searchStr, isNull, err = b.args[2].EvalString(row)
	if isNull || err != nil {
		return res, isNull, err
	}
	escape := byte('\\')
	if len(b.args) >= 4 {
		...
		escapeStr, isNull, err = b.args[3].EvalString(row)
		if err != nil {
			return res, isNull, err
		}
...
func (c *jsonStorageFreeFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (c *jsonStorageSizeFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (c *jsonDepthFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (c *jsonKeysFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
...
func (b *builtinJSONKeysSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (b *builtinJSONKeys2ArgsSig) evalJSON(row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(row)
	if isNull || err != nil {
		return res, isNull, err
	}

	path, isNull, err := b.args[1].EvalString(row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (c *jsonLengthFunctionClass) getFunction(ctx *ExprContext, args []Expression) (builtinFunc, error) {
	if err := c.verifyArgs(args); err != nil {
		return nil, err
	}
