...
func (b *builtinLikeSig) vecEvalInt(input *chunk.Chunk, result *chunk.Column) error {
	...
	if err = b.args[0].VecEvalString(input, bufVal); err != nil {
		return err
	}
	...
	if err = b.args[1].VecEvalString(input, bufPattern); err != nil {
		return err
	}
	...
	if err = b.args[2].VecEvalInt(input, bufEscape); err != nil {
		return err
	}
