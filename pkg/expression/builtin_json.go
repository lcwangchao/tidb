...
func (b *builtinJSONTypeSig) evalString(sctx sessionctx.Context, row chunk.Row) (val string, isNull bool, err error) {
	var j types.BinaryJSON
	j, isNull, err = b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (b *builtinJSONExtractSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return
	}
	...
	for _, arg := range b.args[1:] {
		var s string
		s, isNull, err = arg.EvalString(sctx, row)
		if isNull || err != nil {
...
func (b *builtinJSONUnquoteSig) evalString(sctx sessionctx.Context, row chunk.Row) (str string, isNull bool, err error) {
...
func (b *builtinJSONSetSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = jsonModify(sctx, b.args, row, types.JSONModifySet)
	return res, isNull, err
}
...
func (b *builtinJSONInsertSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = jsonModify(sctx, b.args, row, types.JSONModifyInsert)
	return res, isNull, err
}
...
func (b *builtinJSONReplaceSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = jsonModify(sctx, b.args, row, types.JSONModifyReplace)
	return res, isNull, err
}
...
func (b *builtinJSONRemoveSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (b *builtinJSONMergeSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	values := make([]types.BinaryJSON, 0, len(b.args))
	for _, arg := range b.args {
		var value types.BinaryJSON
		value, isNull, err = arg.EvalJSON(sctx, row)
		if isNull || err != nil {
			return res, isNull, err
		}
	...
	if b.pbCode == tipb.ScalarFuncSig_JsonMergeSig {
		sctx.GetSessionVars().StmtCtx.AppendWarning(errDeprecatedSyntaxNoReplacement.GenWithStackByArgs("JSON_MERGE"))
	}
	return res, false, nil
}
...
func (b *builtinJSONObjectSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	if len(b.args)&1 == 1 {
	...
	for i, arg := range b.args {
		if i&1 == 0 {
			key, isNull, err = arg.EvalString(sctx, row)
			if err != nil {
				return res, true, err
			}
			if isNull {
...
func (b *builtinJSONArraySig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	jsons := make([]interface{}, 0, len(b.args))
	for _, arg := range b.args {
		j, isNull, err := arg.EvalJSON(sctx, row)
		if err != nil {
			return res, true, err
		}
		if isNull {
...
func (b *builtinJSONContainsPathSig) evalInt(sctx sessionctx.Context, row chunk.Row) (res int64, isNull bool, err error) {
	obj, isNull, err := b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
	containType, isNull, err := b.args[1].EvalString(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
	...
	for i := 2; i < len(b.args); i++ {
		path, isNull, err := b.args[i].EvalString(sctx, row)
		if isNull || err != nil {
			return res, isNull, err
		}
...
func (b *builtinJSONMemberOfSig) evalInt(sctx sessionctx.Context, row chunk.Row) (res int64, isNull bool, err error) {
	target, isNull, err := b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
	obj, isNull, err := b.args[1].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (b *builtinJSONContainsSig) evalInt(sctx sessionctx.Context, row chunk.Row) (res int64, isNull bool, err error) {
	obj, isNull, err := b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
	target, isNull, err := b.args[1].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
	var pathExpr types.JSONPathExpression
	if len(b.args) == 3 {
		path, isNull, err := b.args[2].EvalString(sctx, row)
		if isNull || err != nil {
			return res, isNull, err
		}
...
func (b *builtinJSONOverlapsSig) evalInt(sctx sessionctx.Context, row chunk.Row) (res int64, isNull bool, err error) {
	obj, isNull, err := b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (b *builtinJSONValidJSONSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	_, isNull, err = b.args[0].EvalJSON(sctx, row)
	return 1, isNull, err
}
...
// See https://dev.mysql.com/doc/refman/5.7/en/json-attribute-functions.html#function_json-valid
func (b *builtinJSONValidStringSig) evalInt(sctx sessionctx.Context, row chunk.Row) (res int64, isNull bool, err error) {
...
// See https://dev.mysql.com/doc/refman/5.7/en/json-attribute-functions.html#function_json-valid
func (b *builtinJSONValidOthersSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return 0, false, nil
}
...
func (b *builtinJSONArrayAppendSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(sctx, row)
	if err != nil || isNull {
		return res, true, err
	}
	...
	for i := 1; i < len(b.args)-1; i += 2 {
		...
		s, sNull, err := b.args[i].EvalString(sctx, row)
		if sNull || err != nil {
			return res, true, err
		}
		value, vNull, err := b.args[i+1].EvalJSON(sctx, row)
		if err != nil {
			return res, true, err
		}
		if vNull {
...
func (b *builtinJSONArrayInsertSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(sctx, row)
	if err != nil || isNull {
		return res, true, err
	}
	...
	for i := 1; i < len(b.args)-1; i += 2 {
		// If JSON path is NULL, MySQL breaks and returns NULL.
		s, isNull, err := b.args[i].EvalString(sctx, row)
		if err != nil || isNull {
			return res, true, err
		}
		...
		value, isnull, err := b.args[i+1].EvalJSON(sctx, row)
		if err != nil {
			return res, true, err
		}
...
func (b *builtinJSONMergePatchSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	values := make([]*types.BinaryJSON, 0, len(b.args))
	for _, arg := range b.args {
		var value types.BinaryJSON
		value, isNull, err = arg.EvalJSON(sctx, row)
...
func (b *builtinJSONSPrettySig) evalString(sctx sessionctx.Context, row chunk.Row) (res string, isNull bool, err error) {
	obj, isNull, err := b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (b *builtinJSONQuoteSig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	str, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (b *builtinJSONSearchSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	// json_doc
	...
	searchStr, isNull, err = b.args[2].EvalString(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
	escape := byte('\\')
	if len(b.args) >= 4 {
		...
		escapeStr, isNull, err = b.args[3].EvalString(sctx, row)
		if err != nil {
			return res, isNull, err
		}
...
func (b *builtinJSONStorageFreeSig) evalInt(sctx sessionctx.Context, row chunk.Row) (res int64, isNull bool, err error) {
	_, isNull, err = b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (b *builtinJSONStorageSizeSig) evalInt(sctx sessionctx.Context, row chunk.Row) (res int64, isNull bool, err error) {
	obj, isNull, err := b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (b *builtinJSONDepthSig) evalInt(sctx sessionctx.Context, row chunk.Row) (res int64, isNull bool, err error) {
...
func (b *builtinJSONKeysSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (b *builtinJSONKeys2ArgsSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	res, isNull, err = b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}

	path, isNull, err := b.args[1].EvalString(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
...
func (b *builtinJSONLengthSig) evalInt(sctx sessionctx.Context, row chunk.Row) (res int64, isNull bool, err error) {
	obj, isNull, err := b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
