...
func (b *builtinArithmeticMultiplyRealSig) vecEvalReal(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
...
func (b *builtinArithmeticDivideDecimalSig) vecEvalDecimal(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	...
	for i := 0; i < n; i++ {
		...
		if err == types.ErrDivByZero {
			if err = handleDivisionByZeroError(sctx); err != nil {
				return err
			}
...
func (b *builtinArithmeticModIntUnsignedUnsignedSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	lh, err := b.bufAllocator.get()
	if err != nil {
		return err
	}
	defer b.bufAllocator.put(lh)
	if err := b.args[0].VecEvalInt(sctx, input, lh); err != nil {
		return err
	}
	// reuse result as rh to avoid buf allocate
	if err := b.args[1].VecEvalInt(sctx, input, result); err != nil {
		return err
	}
...
func (b *builtinArithmeticModIntUnsignedSignedSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	lh, err := b.bufAllocator.get()
	if err != nil {
		return err
	}
...
func (b *builtinArithmeticModIntSignedUnsignedSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	lh, err := b.bufAllocator.get()
	if err != nil {
		return err
	}
...
func (b *builtinArithmeticModIntSignedSignedSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	lh, err := b.bufAllocator.get()
	if err != nil {
		return err
	}
...
func (b *builtinArithmeticMinusRealSig) vecEvalReal(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	if err := b.args[0].VecEvalReal(sctx, input, result); err != nil {
		return err
	}
	n := input.NumRows()
...
func (b *builtinArithmeticMinusDecimalSig) vecEvalDecimal(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	if err := b.args[0].VecEvalDecimal(sctx, input, result); err != nil {
		return err
	}
	n := input.NumRows()
...
func (b *builtinArithmeticMinusIntSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	lh, err := b.bufAllocator.get()
	if err != nil {
		return err
	}
	...
	forceToSigned := sctx.GetSessionVars().SQLMode.HasNoUnsignedSubtractionMode()
...
func (b *builtinArithmeticModRealSig) vecEvalReal(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
	buf, err := b.bufAllocator.get()
	if err != nil {
		return err
...
func (b *builtinArithmeticModDecimalSig) vecEvalDecimal(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	if err := b.args[0].VecEvalDecimal(sctx, input, result); err != nil {
		return err
	}
	n := input.NumRows()
...
func (b *builtinArithmeticPlusRealSig) vecEvalReal(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	if err := b.args[0].VecEvalReal(sctx, input, result); err != nil {
		return err
	}
	n := input.NumRows()
...
func (b *builtinArithmeticMultiplyDecimalSig) vecEvalDecimal(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	if err := b.args[0].VecEvalDecimal(sctx, input, result); err != nil {
		return err
	}
	n := input.NumRows()
...
func (b *builtinArithmeticIntDivideDecimalSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	sc := sctx.GetSessionVars().StmtCtx
	n := input.NumRows()
	var err error
	...
	for i, arg := range b.args {
		...
		err = arg.VecEvalDecimal(sctx, input, buf[i])
		if err != nil {
			return err
		}
...
func (b *builtinArithmeticMultiplyIntSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
...
func (b *builtinArithmeticDivideRealSig) vecEvalReal(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	if err := b.args[0].VecEvalReal(sctx, input, result); err != nil {
		return err
	}
	n := input.NumRows()
...
func (b *builtinArithmeticIntDivideIntSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	...
	if err := b.args[0].VecEvalInt(sctx, input, lhsBuf); err != nil {
		return err
	}
	...
	case isLHSUnsigned && isRHSUnsigned:
		err = b.divideUU(sctx, result, lhsI64s, rhsI64s, resultI64s)
	case isLHSUnsigned && !isRHSUnsigned:
		err = b.divideUS(sctx, result, lhsI64s, rhsI64s, resultI64s)
	case !isLHSUnsigned && isRHSUnsigned:
		err = b.divideSU(sctx, result, lhsI64s, rhsI64s, resultI64s)
	case !isLHSUnsigned && !isRHSUnsigned:
		err = b.divideSS(sctx, result, lhsI64s, rhsI64s, resultI64s)
	}
	return err
}

func (b *builtinArithmeticIntDivideIntSig) divideUU(sctx sessionctx.Context, result *chunk.Column, lhsI64s, rhsI64s, resultI64s []int64) error {
...
func (b *builtinArithmeticIntDivideIntSig) divideUS(sctx sessionctx.Context, result *chunk.Column, lhsI64s, rhsI64s, resultI64s []int64) error {
	for i := 0; i < len(lhsI64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticIntDivideIntSig) divideSU(sctx sessionctx.Context, result *chunk.Column, lhsI64s, rhsI64s, resultI64s []int64) error {
	for i := 0; i < len(lhsI64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticIntDivideIntSig) divideSS(sctx sessionctx.Context, result *chunk.Column, lhsI64s, rhsI64s, resultI64s []int64) error {
	for i := 0; i < len(lhsI64s); i++ {
		if result.IsNull(i) {
			continue
		}
...
func (b *builtinArithmeticPlusIntSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	lh, err := b.bufAllocator.get()
	if err != nil {
		return err
	}
...
func (b *builtinArithmeticPlusDecimalSig) vecEvalDecimal(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	if err := b.args[0].VecEvalDecimal(sctx, input, result); err != nil {
		return err
	}
	n := input.NumRows()
...
func (b *builtinArithmeticMultiplyIntUnsignedSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	if err := b.args[0].VecEvalInt(sctx, input, result); err != nil {
		return err
	}
	n := input.NumRows()
