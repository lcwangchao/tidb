...
func (b *builtinInIntSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
	...
	for j := 0; j < len(args); j++ {
		if err := args[j].VecEvalInt(sctx, input, buf1); err != nil {
			return err
		}
...
func (b *builtinInStringSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
	buf0, err := b.bufAllocator.get()
	if err != nil {
		return err
	...
	for j := 0; j < len(args); j++ {
		if err := args[j].VecEvalString(sctx, input, buf1); err != nil {
			return err
		}
		for i := 0; i < n; i++ {
			if r64s[i] != 0 {
...
func (b *builtinInDecimalSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
	buf0, err := b.bufAllocator.get()
	if err != nil {
		return err
	...
	for j := 0; j < len(args); j++ {
		if err := args[j].VecEvalDecimal(sctx, input, buf1); err != nil {
			return err
		}
		args1 := buf1.Decimals()
		buf1.MergeNulls(buf0)
...
func (b *builtinInRealSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
	buf0, err := b.bufAllocator.get()
	if err != nil {
		return err
	...
	for j := 0; j < len(args); j++ {
		if err := args[j].VecEvalReal(sctx, input, buf1); err != nil {
			return err
		}
		args1 := buf1.Float64s()
		buf1.MergeNulls(buf0)
...
func (b *builtinInTimeSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
	buf0, err := b.bufAllocator.get()
	if err != nil {
		return err
	...
	for j := 0; j < len(args); j++ {
		if err := args[j].VecEvalTime(sctx, input, buf1); err != nil {
			return err
		}
		args1 := buf1.Times()
		buf1.MergeNulls(buf0)
...
func (b *builtinInDurationSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
	buf0, err := b.bufAllocator.get()
	if err != nil {
		return err
	...
	for j := 0; j < len(args); j++ {
		if err := args[j].VecEvalDuration(sctx, input, buf1); err != nil {
			return err
		}
...
func (b *builtinInJSONSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
	buf0, err := b.bufAllocator.get()
	if err != nil {
		return err
	...
	for j := 0; j < len(args); j++ {
		if err := args[j].VecEvalJSON(sctx, input, buf1); err != nil {
			return err
		}
		for i := 0; i < n; i++ {
			if r64s[i] != 0 {
