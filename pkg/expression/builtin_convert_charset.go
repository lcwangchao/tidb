...
func (b *builtinInternalToBinarySig) evalString(sctx sessionctx.Context, row chunk.Row) (res string, isNull bool, err error) {
...
func (b *builtinInternalToBinarySig) vecEvalString(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
...
func (b *builtinInternalFromBinarySig) evalString(sctx sessionctx.Context, row chunk.Row) (res string, isNull bool, err error) {
	val, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
...
func (b *builtinInternalFromBinarySig) vecEvalString(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	n := input.NumRows()
	buf, err := b.bufAllocator.get()
	if err != nil {
		return err
