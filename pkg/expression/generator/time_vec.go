...
{{ if $reuse }}
	if err := b.args[0].VecEval{{ .TypeA.TypeName }}(sctx, input, result); err != nil {
		return err
	}
	buf0 := result
{{ else }}
	...
	if err := b.args[0].VecEval{{ .TypeA.TypeName }}(sctx, input, buf0); err != nil {
		return err
	}
{{ end }}
...
{{ end }}
	...
	if err := b.args[1].VecEval{{ .TypeB.TypeName }}(sctx, input, buf1); err != nil {
		return err
	}
