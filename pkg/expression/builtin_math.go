...
func (b *builtinAbsRealSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_abs
func (b *builtinAbsIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
...
// evalInt evals ABS(value).
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_abs
func (b *builtinAbsUIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_abs
func (b *builtinAbsDecSig) evalDecimal(sctx sessionctx.Context, row chunk.Row) (*types.MyDecimal, bool, error) {
...
func (b *builtinRoundRealSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_round
func (b *builtinRoundIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	return b.args[0].EvalInt(sctx, row)
}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_round
func (b *builtinRoundDecSig) evalDecimal(sctx sessionctx.Context, row chunk.Row) (*types.MyDecimal, bool, error) {
	val, isNull, err := b.args[0].EvalDecimal(sctx, row)
	if isNull || err != nil {
		return nil, isNull, err
	}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_round
func (b *builtinRoundWithFracRealSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
	frac, isNull, err := b.args[1].EvalInt(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_round
func (b *builtinRoundWithFracIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	val, isNull, err := b.args[0].EvalInt(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_round
func (b *builtinRoundWithFracDecSig) evalDecimal(sctx sessionctx.Context, row chunk.Row) (*types.MyDecimal, bool, error) {
	val, isNull, err := b.args[0].EvalDecimal(sctx, row)
	if isNull || err != nil {
		return nil, isNull, err
	}
...
func (b *builtinCeilRealSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_ceil
func (b *builtinCeilIntToIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	return b.args[0].EvalInt(sctx, row)
}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_Ceil
func (b *builtinCeilIntToDecSig) evalDecimal(sctx sessionctx.Context, row chunk.Row) (*types.MyDecimal, bool, error) {
	val, isNull, err := b.args[0].EvalInt(sctx, row)
	if isNull || err != nil {
		return nil, true, err
	}
...
// Ceil receives
func (b *builtinCeilDecToIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	val, isNull, err := b.args[0].EvalDecimal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinCeilDecToDecSig) evalDecimal(sctx sessionctx.Context, row chunk.Row) (*types.MyDecimal, bool, error) {
	val, isNull, err := b.args[0].EvalDecimal(sctx, row)
	if isNull || err != nil {
		return nil, isNull, err
	}
...
func (b *builtinFloorRealSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_floor
func (b *builtinFloorIntToIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	return b.args[0].EvalInt(sctx, row)
}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_floor
func (b *builtinFloorIntToDecSig) evalDecimal(sctx sessionctx.Context, row chunk.Row) (*types.MyDecimal, bool, error) {
	val, isNull, err := b.args[0].EvalInt(sctx, row)
	if isNull || err != nil {
		return nil, true, err
	}
...
// floor receives
func (b *builtinFloorDecToIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	val, isNull, err := b.args[0].EvalDecimal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinFloorDecToDecSig) evalDecimal(sctx sessionctx.Context, row chunk.Row) (*types.MyDecimal, bool, error) {
	val, isNull, err := b.args[0].EvalDecimal(sctx, row)
	if isNull || err != nil {
		return nil, true, err
	}
...
func (b *builtinLog1ArgSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_log
func (b *builtinLog2ArgsSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val1, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}

	val2, isNull, err := b.args[1].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinLog2Sig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinLog10Sig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinRandSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	res := b.mysqlRng.Gen()
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_rand
func (b *builtinRandWithSeedFirstGenSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	seed, isNull, err := b.args[0].EvalInt(sctx, row)
	if err != nil {
		return 0, true, err
	}
...
func (b *builtinPowSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	x, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
	y, isNull, err := b.args[1].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
	power := math.Pow(x, y)
...
func (b *builtinConvSig) evalString(sctx sessionctx.Context, row chunk.Row) (res string, isNull bool, err error) {
	var str string
	...
	case *ScalarFunction:
		if x.FuncName.L == ast.Cast {
			...
			if arg0.GetType().Hybrid() || IsBinaryLiteral(arg0) {
				str, isNull, err = arg0.EvalString(sctx, row)
				if isNull || err != nil {
	...
	fromBase, isNull, err := b.args[1].EvalInt(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}

	toBase, isNull, err := b.args[2].EvalInt(sctx, row)
	if isNull || err != nil {
		return res, isNull, err
	}
	if len(str) == 0 {
...
func (b *builtinCRC32Sig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	x, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinSignSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinSqrtSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinAcosSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinAsinSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinAtan1ArgSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_atan
func (b *builtinAtan2ArgsSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val1, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinCosSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinCotSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinDegreesSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinExpSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinPISig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
...
func (b *builtinRadiansSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	x, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinSinSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinTanSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	val, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinTruncateDecimalSig) evalDecimal(sctx sessionctx.Context, row chunk.Row) (*types.MyDecimal, bool, error) {
	x, isNull, err := b.args[0].EvalDecimal(sctx, row)
	if isNull || err != nil {
		return nil, isNull, err
	}

	d, isNull, err := b.args[1].EvalInt(sctx, row)
	if isNull || err != nil {
		return nil, isNull, err
	}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_truncate
func (b *builtinTruncateRealSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
	x, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_truncate
func (b *builtinTruncateIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
...
// evalInt evals a TRUNCATE(X,D).
// See https://dev.mysql.com/doc/refman/5.7/en/mathematical-functions.html#function_truncate
func (b *builtinTruncateUintSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	x, isNull, err := b.args[0].EvalInt(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
