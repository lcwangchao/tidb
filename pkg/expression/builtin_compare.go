...
func (b *builtinCoalesceIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (res int64, isNull bool, err error) {
	for _, a := range b.getArgs() {
		res, isNull, err = a.EvalInt(sctx, row)
		if err != nil || !isNull {
			break
		}
	}
...
func (b *builtinCoalesceRealSig) evalReal(sctx sessionctx.Context, row chunk.Row) (res float64, isNull bool, err error) {
	for _, a := range b.getArgs() {
		res, isNull, err = a.EvalReal(sctx, row)
		if err != nil || !isNull {
			break
		}
	}
...
func (b *builtinCoalesceDecimalSig) evalDecimal(sctx sessionctx.Context, row chunk.Row) (res *types.MyDecimal, isNull bool, err error) {
	for _, a := range b.getArgs() {
		res, isNull, err = a.EvalDecimal(sctx, row)
		if err != nil || !isNull {
			break
		}
	}
...
func (b *builtinCoalesceStringSig) evalString(sctx sessionctx.Context, row chunk.Row) (res string, isNull bool, err error) {
	for _, a := range b.getArgs() {
		res, isNull, err = a.EvalString(sctx, row)
		if err != nil || !isNull {
			break
		}
	}
...
func (b *builtinCoalesceTimeSig) evalTime(sctx sessionctx.Context, row chunk.Row) (res types.Time, isNull bool, err error) {
	fsp := b.tp.GetDecimal()
	for _, a := range b.getArgs() {
		res, isNull, err = a.EvalTime(sctx, row)
		res.SetFsp(fsp)
		if err != nil || !isNull {
			break
		}
...
func (b *builtinCoalesceDurationSig) evalDuration(sctx sessionctx.Context, row chunk.Row) (res types.Duration, isNull bool, err error) {
	for _, a := range b.getArgs() {
		res, isNull, err = a.EvalDuration(sctx, row)
...
func (b *builtinCoalesceJSONSig) evalJSON(sctx sessionctx.Context, row chunk.Row) (res types.BinaryJSON, isNull bool, err error) {
	for _, a := range b.getArgs() {
		res, isNull, err = a.EvalJSON(sctx, row)
		if err != nil || !isNull {
			break
		}
	}
...
func (b *builtinGreatestIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (max int64, isNull bool, err error) {
	max, isNull, err = b.args[0].EvalInt(sctx, row)
	if isNull || err != nil {
		return max, isNull, err
	}
	for i := 1; i < len(b.args); i++ {
		var v int64
		v, isNull, err = b.args[i].EvalInt(sctx, row)
		if isNull || err != nil {
			return max, isNull, err
		}
		if v > max {
...
// See http://dev.mysql.com/doc/refman/5.7/en/comparison-operators.html#function_greatest
func (b *builtinGreatestRealSig) evalReal(sctx sessionctx.Context, row chunk.Row) (max float64, isNull bool, err error) {
	max, isNull, err = b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return max, isNull, err
	}
	for i := 1; i < len(b.args); i++ {
		var v float64
		v, isNull, err = b.args[i].EvalReal(sctx, row)
		if isNull || err != nil {
			return max, isNull, err
		}
		if v > max {
...
// See http://dev.mysql.com/doc/refman/5.7/en/comparison-operators.html#function_greatest
func (b *builtinGreatestDecimalSig) evalDecimal(sctx sessionctx.Context, row chunk.Row) (max *types.MyDecimal, isNull bool, err error) {
	max, isNull, err = b.args[0].EvalDecimal(sctx, row)
	if isNull || err != nil {
		return max, isNull, err
	}
	for i := 1; i < len(b.args); i++ {
		var v *types.MyDecimal
		v, isNull, err = b.args[i].EvalDecimal(sctx, row)
		if isNull || err != nil {
			return max, isNull, err
		}
		if v.Compare(max) > 0 {
...
// See http://dev.mysql.com/doc/refman/5.7/en/comparison-operators.html#function_greatest
func (b *builtinGreatestStringSig) evalString(sctx sessionctx.Context, row chunk.Row) (max string, isNull bool, err error) {
	max, isNull, err = b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return max, isNull, err
	}
	for i := 1; i < len(b.args); i++ {
		var v string
		v, isNull, err = b.args[i].EvalString(sctx, row)
		if isNull || err != nil {
			return max, isNull, err
		}
...
// See http://dev.mysql.com/doc/refman/5.7/en/comparison-operators.html#function_greatest
func (b *builtinGreatestCmpStringAsTimeSig) evalString(sctx sessionctx.Context, row chunk.Row) (strRes string, isNull bool, err error) {
	...
	for i := 0; i < len(b.args); i++ {
		...
		v, err = doTimeConversionForGL(b.cmpAsDate, sctx, sc, v)
		if err != nil {
			return v, true, err
		}
...
func (b *builtinGreatestTimeSig) evalTime(sctx sessionctx.Context, row chunk.Row) (res types.Time, isNull bool, err error) {
	for i := 0; i < len(b.args); i++ {
		v, isNull, err := b.args[i].EvalTime(sctx, row)
		if isNull || err != nil {
...
func (b *builtinGreatestDurationSig) evalDuration(sctx sessionctx.Context, row chunk.Row) (res types.Duration, isNull bool, err error) {
	for i := 0; i < len(b.args); i++ {
		v, isNull, err := b.args[i].EvalDuration(sctx, row)
		if isNull || err != nil {
...
func (b *builtinLeastIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (min int64, isNull bool, err error) {
	min, isNull, err = b.args[0].EvalInt(sctx, row)
	if isNull || err != nil {
...
func (b *builtinLeastRealSig) evalReal(sctx sessionctx.Context, row chunk.Row) (min float64, isNull bool, err error) {
	min, isNull, err = b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return min, isNull, err
	}
	for i := 1; i < len(b.args); i++ {
...
// See http://dev.mysql.com/doc/refman/5.7/en/comparison-operators.html#functionleast
func (b *builtinLeastDecimalSig) evalDecimal(sctx sessionctx.Context, row chunk.Row) (min *types.MyDecimal, isNull bool, err error) {
	min, isNull, err = b.args[0].EvalDecimal(sctx, row)
	if isNull || err != nil {
		return min, isNull, err
	}
	for i := 1; i < len(b.args); i++ {
...
// See http://dev.mysql.com/doc/refman/5.7/en/comparison-operators.html#functionleast
func (b *builtinLeastStringSig) evalString(sctx sessionctx.Context, row chunk.Row) (min string, isNull bool, err error) {
	min, isNull, err = b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return min, isNull, err
	}
	for i := 1; i < len(b.args); i++ {
...
// See http://dev.mysql.com/doc/refman/5.7/en/comparison-operators.html#functionleast
func (b *builtinLeastCmpStringAsTimeSig) evalString(sctx sessionctx.Context, row chunk.Row) (strRes string, isNull bool, err error) {
	sc := sctx.GetSessionVars().StmtCtx
	for i := 0; i < len(b.args); i++ {
		v, isNull, err := b.args[i].EvalString(sctx, row)
		if isNull || err != nil {
...
func (b *builtinLeastTimeSig) evalTime(sctx sessionctx.Context, row chunk.Row) (res types.Time, isNull bool, err error) {
	for i := 0; i < len(b.args); i++ {
		v, isNull, err := b.args[i].EvalTime(sctx, row)
		if isNull || err != nil {
			return types.ZeroTime, true, err
...
func (b *builtinLeastDurationSig) evalDuration(sctx sessionctx.Context, row chunk.Row) (res types.Duration, isNull bool, err error) {
	for i := 0; i < len(b.args); i++ {
		v, isNull, err := b.args[i].EvalDuration(sctx, row)
		if isNull || err != nil {
			return types.Duration{}, true, err
...
func (b *builtinIntervalIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	arg0, isNull, err := b.args[0].EvalInt(sctx, row)
	if err != nil {
		return 0, true, err
	}
	if isNull {
	...
	var idx int
	if b.hasNullable {
		idx, err = b.linearSearch(sctx, arg0, isUint1, b.args[1:], row)
	} else {
		idx, err = b.binSearch(sctx, arg0, isUint1, b.args[1:], row)
	}
...
func (b *builtinIntervalIntSig) linearSearch(sctx sessionctx.Context, target int64, isUint1 bool, args []Expression, row chunk.Row) (i int, err error) {
	i = 0
	for ; i < len(args); i++ {
		isUint2 := mysql.HasUnsignedFlag(args[i].GetType().GetFlag())
		arg, isNull, err := args[i].EvalInt(sctx, row)
		if err != nil {
			return 0, err
		}
		var less bool
...
func (b *builtinIntervalIntSig) binSearch(sctx sessionctx.Context, target int64, isUint1 bool, args []Expression, row chunk.Row) (_ int, err error) {
	i, j, cmp := 0, len(args), false
	for i < j {
		mid := i + (j-i)/2
		v, isNull, err1 := args[mid].EvalInt(sctx, row)
		if err1 != nil {
			err = err1
			break
		}
...
// See http://dev.mysql.com/doc/refman/5.7/en/comparison-operators.html#function_interval
func (b *builtinIntervalRealSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	arg0, isNull, err := b.args[0].EvalReal(sctx, row)
	if err != nil {
		return 0, true, err
	}
	if isNull {
	...
	var idx int
	if b.hasNullable {
		idx, err = b.linearSearch(sctx, arg0, b.args[1:], row)
	} else {
		idx, err = b.binSearch(sctx, arg0, b.args[1:], row)
	}
	return int64(idx), err != nil, err
}

func (b *builtinIntervalRealSig) linearSearch(sctx sessionctx.Context, target float64, args []Expression, row chunk.Row) (i int, err error) {
	i = 0
	for ; i < len(args); i++ {
		arg, isNull, err := args[i].EvalReal(sctx, row)
		if err != nil {
			return 0, err
		}
...
func (b *builtinIntervalRealSig) binSearch(sctx sessionctx.Context, target float64, args []Expression, row chunk.Row) (_ int, err error) {
	i, j := 0, len(args)
	for i < j {
		mid := i + (j-i)/2
		v, isNull, err1 := args[mid].EvalReal(sctx, row)
		if err1 != nil {
			err = err1
			break
		}
...
func (b *builtinLTIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLT(CompareInt(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinLTRealSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLT(CompareReal(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinLTDecimalSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLT(CompareDecimal(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinLTStringSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLT(CompareStringWithCollationInfo(sctx, b.args[0], b.args[1], row, row, b.collation))
}
...
func (b *builtinLTDurationSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLT(CompareDuration(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinLTTimeSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLT(CompareTime(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinLTJSONSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLT(CompareJSON(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinLEIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLE(CompareInt(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinLERealSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLE(CompareReal(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinLEDecimalSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLE(CompareDecimal(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinLEStringSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLE(CompareStringWithCollationInfo(sctx, b.args[0], b.args[1], row, row, b.collation))
}
...
func (b *builtinLEDurationSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLE(CompareDuration(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinLETimeSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLE(CompareTime(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinLEJSONSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfLE(CompareJSON(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinGTIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGT(CompareInt(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinGTRealSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGT(CompareReal(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinGTDecimalSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGT(CompareDecimal(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinGTStringSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGT(CompareStringWithCollationInfo(sctx, b.args[0], b.args[1], row, row, b.collation))
}
...
func (b *builtinGTDurationSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGT(CompareDuration(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinGTTimeSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGT(CompareTime(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinGTJSONSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGT(CompareJSON(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinGEIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGE(CompareInt(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinGERealSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGE(CompareReal(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinGEDecimalSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGE(CompareDecimal(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinGEStringSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGE(CompareStringWithCollationInfo(sctx, b.args[0], b.args[1], row, row, b.collation))
}
...
func (b *builtinGEDurationSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGE(CompareDuration(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinGETimeSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGE(CompareTime(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinGEJSONSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfGE(CompareJSON(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinEQIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfEQ(CompareInt(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinEQRealSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfEQ(CompareReal(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinEQDecimalSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfEQ(CompareDecimal(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinEQStringSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfEQ(CompareStringWithCollationInfo(sctx, b.args[0], b.args[1], row, row, b.collation))
}
...
func (b *builtinEQDurationSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfEQ(CompareDuration(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinEQTimeSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfEQ(CompareTime(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinEQJSONSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfEQ(CompareJSON(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinNEIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfNE(CompareInt(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinNERealSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfNE(CompareReal(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinNEDecimalSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfNE(CompareDecimal(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinNEStringSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfNE(CompareStringWithCollationInfo(sctx, b.args[0], b.args[1], row, row, b.collation))
}
...
func (b *builtinNEDurationSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfNE(CompareDuration(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinNETimeSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfNE(CompareTime(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinNEJSONSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	return resOfNE(CompareJSON(sctx, b.args[0], b.args[1], row, row))
}
...
func (b *builtinNullEQIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	arg0, isNull0, err := b.args[0].EvalInt(sctx, row)
	if err != nil {
		return 0, isNull0, err
	}
	arg1, isNull1, err := b.args[1].EvalInt(sctx, row)
	if err != nil {
...
func (b *builtinNullEQRealSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	arg0, isNull0, err := b.args[0].EvalReal(sctx, row)
	if err != nil {
		return 0, true, err
	}
	arg1, isNull1, err := b.args[1].EvalReal(sctx, row)
	if err != nil {
		return 0, true, err
	}
	var res int64
...
func (b *builtinNullEQDecimalSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	arg0, isNull0, err := b.args[0].EvalDecimal(sctx, row)
	if err != nil {
		return 0, true, err
	}
	arg1, isNull1, err := b.args[1].EvalDecimal(sctx, row)
	if err != nil {
		return 0, true, err
	}
	var res int64
...
func (b *builtinNullEQStringSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	arg0, isNull0, err := b.args[0].EvalString(sctx, row)
	if err != nil {
		return 0, true, err
	}
	arg1, isNull1, err := b.args[1].EvalString(sctx, row)
	if err != nil {
		return 0, true, err
	}
	var res int64
...
func (b *builtinNullEQDurationSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	arg0, isNull0, err := b.args[0].EvalDuration(sctx, row)
	if err != nil {
		return 0, true, err
	}
	arg1, isNull1, err := b.args[1].EvalDuration(sctx, row)
	if err != nil {
		return 0, true, err
	}
	var res int64
...
func (b *builtinNullEQTimeSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	arg0, isNull0, err := b.args[0].EvalTime(sctx, row)
	if err != nil {
		return 0, true, err
	}
	arg1, isNull1, err := b.args[1].EvalTime(sctx, row)
	if err != nil {
		return 0, true, err
	}
	var res int64
...
func (b *builtinNullEQJSONSig) evalInt(sctx sessionctx.Context, row chunk.Row) (val int64, isNull bool, err error) {
	arg0, isNull0, err := b.args[0].EvalJSON(sctx, row)
	if err != nil {
		return 0, true, err
	}
	arg1, isNull1, err := b.args[1].EvalJSON(sctx, row)
	if err != nil {
		return 0, true, err
	}
	var res int64
