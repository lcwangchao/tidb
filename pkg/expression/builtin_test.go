...
func evalBuiltinFunc(f builtinFunc, row chunk.Row) (d types.Datum, err error) {
	...
	case types.ETDecimal:
		res, isNull, err = f.evalDecimal(nil, row)
	case types.ETDatetime, types.ETTimestamp:
		res, isNull, err = f.evalTime(nil, row)
	case types.ETDuration:
		res, isNull, err = f.evalDuration(nil, row)
	case types.ETJson:
		res, isNull, err = f.evalJSON(nil, row)
	case types.ETString:
		res, isNull, err = f.evalString(nil, row)
	}
