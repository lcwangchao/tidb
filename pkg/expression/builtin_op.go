...
func (b *builtinLogicAndSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
...
func (b *builtinLogicOrSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	arg0, isNull0, err := b.args[0].EvalInt(sctx, row)
	if err != nil {
		return 0, true, err
	}
...
func (b *builtinLogicXorSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
...
func (b *builtinBitAndSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	arg0, isNull, err := b.args[0].EvalInt(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinBitOrSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	arg0, isNull, err := b.args[0].EvalInt(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinBitXorSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	arg0, isNull, err := b.args[0].EvalInt(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinLeftShiftSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	arg0, isNull, err := b.args[0].EvalInt(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinRightShiftSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	arg0, isNull, err := b.args[0].EvalInt(sctx, row)
	if isNull || err != nil {
		return 0, isNull, err
	}
...
func (b *builtinRealIsTrueSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	input, isNull, err := b.args[0].EvalReal(sctx, row)
	if err != nil {
		return 0, true, err
	}
...
func (b *builtinDecimalIsTrueSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	input, isNull, err := b.args[0].EvalDecimal(sctx, row)
	if err != nil {
		return 0, true, err
	}
	if b.keepNull && isNull {
...
func (b *builtinIntIsTrueSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	input, isNull, err := b.args[0].EvalInt(sctx, row)
	if err != nil {
		return 0, true, err
	}
	if b.keepNull && isNull {
...
func (b *builtinRealIsFalseSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	input, isNull, err := b.args[0].EvalReal(sctx, row)
	if err != nil {
		return 0, true, err
	}
...
func (b *builtinDecimalIsFalseSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	input, isNull, err := b.args[0].EvalDecimal(sctx, row)
	if err != nil {
		return 0, true, err
	}
...
func (b *builtinIntIsFalseSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	input, isNull, err := b.args[0].EvalInt(sctx, row)
	if err != nil {
		return 0, true, err
	}
...
func (b *builtinBitNegSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
...
func (b *builtinUnaryNotRealSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	arg, isNull, err := b.args[0].EvalReal(sctx, row)
	if isNull || err != nil {
		return 0, true, err
	}
	if arg == 0 {
...
func (b *builtinUnaryNotDecimalSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	arg, isNull, err := b.args[0].EvalDecimal(sctx, row)
	if isNull || err != nil {
		return 0, true, err
	}
	if arg.IsZero() {
...
func (b *builtinUnaryNotIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	arg, isNull, err := b.args[0].EvalInt(sctx, row)
	if isNull || err != nil {
		return 0, true, err
	}
...
func (b *builtinUnaryNotJSONSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	arg, isNull, err := b.args[0].EvalJSON(sctx, row)
	if isNull || err != nil {
		return 0, true, err
	}
...
func (b *builtinUnaryMinusIntSig) evalInt(sctx sessionctx.Context, row chunk.Row) (res int64, isNull bool, err error) {
	var val int64
...
func (b *builtinUnaryMinusDecimalSig) evalDecimal(sctx sessionctx.Context, row chunk.Row) (*types.MyDecimal, bool, error) {
	dec, isNull, err := b.args[0].EvalDecimal(sctx, row)
	if err != nil || isNull {
...
func (b *builtinUnaryMinusRealSig) evalReal(sctx sessionctx.Context, row chunk.Row) (float64, bool, error) {
...
func (b *builtinDecimalIsNullSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	_, isNull, err := b.args[0].EvalDecimal(sctx, row)
...
func (b *builtinDurationIsNullSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	_, isNull, err := b.args[0].EvalDuration(sctx, row)
	return evalIsNull(isNull, err)
}
...
func (b *builtinIntIsNullSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	_, isNull, err := b.args[0].EvalInt(sctx, row)
	return evalIsNull(isNull, err)
}
...
func (b *builtinRealIsNullSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	_, isNull, err := b.args[0].EvalReal(sctx, row)
	return evalIsNull(isNull, err)
}
...
func (b *builtinStringIsNullSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	_, isNull, err := b.args[0].EvalString(sctx, row)
	return evalIsNull(isNull, err)
}
...
func (b *builtinTimeIsNullSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	_, isNull, err := b.args[0].EvalTime(sctx, row)
	return evalIsNull(isNull, err)
}
