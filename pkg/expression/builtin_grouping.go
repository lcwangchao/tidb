...
func (b *BuiltinGroupingImplSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	if !b.isMetaInited {
...
func (b *BuiltinGroupingImplSig) vecEvalInt(sctx sessionctx.Context, input *chunk.Chunk, result *chunk.Column) error {
	if !b.isMetaInited {
