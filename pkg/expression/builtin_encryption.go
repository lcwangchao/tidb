...
func (b *builtinAesDecryptSig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	// According to doc: If either function argument is NULL, the function returns NULL.
	cryptStr, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", true, err
	}
	keyStr, isNull, err := b.args[1].EvalString(sctx, row)
	if isNull || err != nil {
		return "", true, err
	}
	if !b.ivRequired && len(b.args) == 3 {
		...
		sctx.GetSessionVars().StmtCtx.AppendWarning(errWarnOptionIgnored.GenWithStackByArgs("IV"))
	}
...
// See https://dev.mysql.com/doc/refman/5.7/en/encryption-functions.html#function_aes-decrypt
func (b *builtinAesDecryptIVSig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	// According to doc: If either function argument is NULL, the function returns NULL.
	cryptStr, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", true, err
	...
	iv, isNull, err := b.args[2].EvalString(sctx, row)
	if isNull || err != nil {
		return "", true, err
	}
...
// See https://dev.mysql.com/doc/refman/5.7/en/encryption-functions.html#function_aes-decrypt
func (b *builtinAesEncryptSig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	// According to doc: If either function argument is NULL, the function returns NULL.
...
// See https://dev.mysql.com/doc/refman/5.7/en/encryption-functions.html#function_aes-decrypt
func (b *builtinAesEncryptIVSig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	// According to doc: If either function argument is NULL, the function returns NULL.
	str, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", true, err
...
func (b *builtinDecodeSig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	dataStr, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", true, err
	}

	passwordStr, isNull, err := b.args[1].EvalString(sctx, row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (b *builtinEncodeSig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	decodeStr, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (b *builtinPasswordSig) evalString(sctx sessionctx.Context, row chunk.Row) (val string, isNull bool, err error) {
	pass, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (b *builtinRandomBytesSig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
...
func (b *builtinMD5Sig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	arg, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (b *builtinSHA1Sig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	str, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (b *builtinSM3Sig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	str, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (b *builtinSHA2Sig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	str, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", isNull, err
	}
	hashLength, isNull, err := b.args[1].EvalInt(sctx, row)
	if isNull || err != nil {
		return "", isNull, err
	}
...
func (b *builtinCompressSig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	str, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", true, err
	}
...
func (b *builtinUncompressSig) evalString(sctx sessionctx.Context, row chunk.Row) (string, bool, error) {
	sc := sctx.GetSessionVars().StmtCtx
	payload, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return "", true, err
	}
	if len(payload) == 0 {
...
func (b *builtinUncompressedLengthSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	sc := sctx.GetSessionVars().StmtCtx
	payload, isNull, err := b.args[0].EvalString(sctx, row)
	if isNull || err != nil {
		return 0, true, err
...
func (b *builtinValidatePasswordStrengthSig) evalInt(sctx sessionctx.Context, row chunk.Row) (int64, bool, error) {
	...
	return b.validateStr(sctx, str, &globalVars)
}

func (b *builtinValidatePasswordStrengthSig) validateStr(sctx sessionctx.Context, str string, globalVars *variable.GlobalVarAccessor) (int64, bool, error) {
	if warn, err := pwdValidator.ValidateUserNameInPassword(str, sctx.GetSessionVars()); err != nil {
		return 0, true, err
	} else if len(warn) > 0 {
		return 0, false, nil
	}
