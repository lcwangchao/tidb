...
var (
	...
	ErrUnsupportedUpdateSoftDeletePK  = dbterror.ClassExecutor.NewStdErr(mysql.ErrNotSupportedYet, parser_mysql.Message("Updating primary key column on soft-delete table is not supported yet", nil))
)
